...
// helper'larından kullanılır (Faz 2 §2.4 refactor, davranış İterasyon 1'dekiyle
// birebir aynıdır — inline kopya kaldırılmıştır, TEFAS/CoinGecko de aynı helper'ı kullanır).
